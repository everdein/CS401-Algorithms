...
public class GreaterThanOrEqualTo <T extends Comparable<T>>
{
    ...
    public GreaterThanOrEqualTo(T mapKey, T rbtKey)
    {
//        super(mapKey, rbtKey);
        this.mapKey = mapKey;
        this.rbtKey = rbtKey;
...
//    @Override
    public HashSet<Integer> execute(Map<T, RedBlackBST<T, HashSet<Integer>>> movieFieldsRBTMap)
    {
        ...
        {
            // If the passed in field (rbtKey) is greater than or equal to the red black tree key currently being compared.
