...
public class LessThan <T extends Comparable<T>>  // extends UnaryExpression
{
    ...
    public LessThan(T mapKey, T rbtKey)
    {
//        super(mapKey, rbtKey);
        this.mapKey = mapKey;
        this.rbtKey = rbtKey;
...
//    @Override
    public HashSet<Integer> execute(Map<T, RedBlackBST<T, HashSet<Integer>>> movieFieldsRBTMap)
    {
        ...
        {
            // If the passed in field (rbtKey) is less than the red black tree key currently being compared.
